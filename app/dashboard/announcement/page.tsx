    ...
    <div className="h-screen gap-8">
      ...
      {announcements && announcements.length > 0 ? (
        announcements.map((announcement) => (
          <AnnouncementCard key={announcement.id} title={announcement.title} content={announcement.content} imageUrl={announcement.user.profileUrl} time={announcement.createdAt} />
        ))
      ) : (
